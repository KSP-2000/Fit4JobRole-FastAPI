...
//                     <p><strong>Matched Skills:</strong> {item.matched_skills} </p>
//                     <p><strong>Missing Skills:</strong> {item.missing_skills} </p>
//                     <p><strong>Match Percentage:</strong> {item.match_percentage} </p>
//                     <p><strong>Job Link:</strong> {item.job_link}</p>
//                   </div>
